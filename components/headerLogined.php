        ...
        <div class="header-top">
            ...
            <div class="container">
                ...
                <ul class="header-social-container">
                    ...
                    <li>
                        <a href="https://www.facebook.com/profile.php?id=100025386050403" class="social-link"
                            target="_blank">
            ...
            <option value="eur">EUR &euro;</option>
                    ...
                    <div name="language" class="d-flex align-items-sm-center fw-bolder">

                    
                        <?php
                        echo "Chào, ";
                        $huhu = mysqli_query($con, "SELECT * FROM users WHERE email = '$email'");
                         if(mysqli_num_rows($huhu) >0){
                            $lnt = mysqli_fetch_assoc($huhu);
                         }
                        ?>
                        <?php echo $lnt['name']?>
                        <div style="padding-left:20px">
                            <button name="dangxuat" class="btn-primary btn"
                                onclick="window.location.href='index.php'">Đăng xuất</button>
                        </div>
        ...
        <div class="header-main">
            ...
            <div class="container">
                ...
                <div class="header-user-actions">
                    ...
                    <button class="action-btn" onclick="openPopup('my-cart.php')">
                    ...
                    function openPopup(url) {
                        ...
                        popup.style.zIndex = ""
                        popup.innerHTML = "<iframe src='my-cart.php' width=100% height= 100%></iframe>";
            ...
            <div class="container">
                ...
                <ul class="desktop-menu-category-list">
                    ...
                    <li class="menu-category">
                        <a href="index1.php" class="menu-title">trang chủ</a>
                    </li>
                    ...
                    <li class="menu-category">
                        <a href="../pdLogined.php" class="menu-title">cửa hàng</a>
